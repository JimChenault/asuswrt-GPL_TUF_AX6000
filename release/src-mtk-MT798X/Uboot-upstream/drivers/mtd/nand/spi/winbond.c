...
#define W25N02KV_STATUS_ECC_HAS_1_4_BITFLIPS	(1 << 4)
#define W25N02KV_STATUS_ECC_UNCOR_ERROR		(2 << 4)
#define W25N02KV_STATUS_ECC_HAS_5_8_BITFLIPS	(3 << 4)
...
#define W25N01KV_STATUS_ECC_HAS_1_3_BITFLIPS	(1 << 4)
#define W25N01KV_STATUS_ECC_UNCOR_ERROR		(2 << 4)
#define W25N01KV_STATUS_ECC_HAS_4_BITFLIPS	(3 << 4)

static int w25n01kv_ecc_get_status(struct spinand_device *spinand, u8 status)
{
	struct nand_device *nand = spinand_to_nand(spinand);
	...
	case W25N01KV_STATUS_ECC_HAS_1_3_BITFLIPS:
		return 3;

	case W25N01KV_STATUS_ECC_UNCOR_ERROR:
		return -EBADMSG;

	case W25N01KV_STATUS_ECC_HAS_4_BITFLIPS:
		/*
		 * We have no way to know exactly how many bitflips have been
		 * fixed, so let's return the maximum possible value so that
		 * wear-leveling layers move the data immediately.
...
static const struct spinand_info winbond_spinand_table_aa21[] = {
	...
	SPINAND_INFO("W25N01GV", 0xAA,
		     ...
		     0,
		     SPINAND_ECCINFO(&w25m02gv_ooblayout, NULL)),
	SPINAND_INFO("W25N01KVxxIR", 0xAE,
